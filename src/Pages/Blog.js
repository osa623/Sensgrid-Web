...
const Blog = () => {
  ...
  return (
    ...
    <div className='relative h-auto w-auto justify-center items-center'>
      <div className='flex lgs:h-[8rem] sms:h-[5rem] w-full'/>
        ...
        <div className='flex lgs:w-[70rem] justify-between items-center'>
          ...
          <img src={blog.image} alt={blog.title} className="lgs:w-[50rem] mt-5 rounded-lg mb-4" style={{
          ...
          <div className='flex lgs:w-[70rem] justify-between items-center lgs:mt-4 sms:mt-5'>
            <h1 className="lgs:text-3xl sms:text-xl  font-bold text-blue-900" style={{
              ...
              <h2 className=" lgs:w-[70vw] lgs:text-md mt-5  text-secondary">{blog.subdescription1}</h2>

              <h2 className=" lgs:w-[70vw] lgs:text-2xl sms:text-xl mt-5  text-secondary">{blog.subtopic12}</h2>
          ...
          {blog.subimage02 && (
              ...
              <h2 className=" lgs:w-[70vw] lgs:text-md mt-5  text-secondary">{blog.subdescription21}</h2>

              <h2 className=" lgs:w-[70vw] lgs:text-2xl sms:text-xl mt-5  text-secondary">{blog.subtopic22}</h2>
